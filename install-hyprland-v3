...
for FONT in otf-font-awesome ttf-jetbrains-mono-nerd ttf-jetbrains-mono otf-font-awesome-4 ttf-droid ttf-fantasque-sans-mono adobe-source-code-pro-fonts ttf-monofur-powerline-git; do
	...
	while true; do
    		...
    		case "$choice" in
        		c|C)
            		...
            		sed -i '23s/#//' config/hypr/hyprland.conf
        		...
        		m|M)
            		...
            		sed -i '24s/#//' config/hypr/hyprland.conf
